...
public class MatchRequestFragment extends Fragment implements View.OnClickListener {
    ...
    private void openFragment(int flag) {
        ...
        if (flag == 0) {
            fragment = ReceivedFragment.newInstance();
        } else {
            fragment = SentFragment.newInstance();
        }
        if (fragment != null) {
