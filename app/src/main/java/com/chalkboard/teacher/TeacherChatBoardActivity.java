...
public class TeacherChatBoardActivity extends Activity {
    ...
    Typeface font, font2;
    private String selectedImagePath = "", str = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isAfterMatchFlag = getIntent().getBooleanExtra("isAfterMatch", false);
...
//		});
        ...
        if (isAfterMatchFlag) {
            showSendMatchRequestDialog(sender_name);
        }
    }
    ...
    private void showSendMatchRequestDialog(String recruiterName) {
        ...
        new CustomAlert(context, TeacherChatBoardActivity.this)
                .singleButtonAlertDialog(
                        ...
                        "sinBtnCallbackResponse", 1000);
    }

    public void sinBtnCallbackResponse(Boolean flag, int code) {
        if (flag) {
