...
public class TeacherPageFragment extends Fragment {
	...
	private void refineUI() {
		...
		try {
			...
			((TextView) rootView.findViewById(R.id.teacher_name)).setTypeface(font2);
			((TextView) rootView.findViewById(R.id.teacher_location)).setTypeface(font);
			((TextView) rootView.findViewById(R.id.add_to_favorite)).setTypeface(font2);
			((TextView) rootView.findViewById(R.id.match_teacher)).setTypeface(font2);
			((TextView) rootView.findViewById(R.id.teacher_about)).setTypeface(font);

			//			((TextView) rootView.findViewById(R.id.current_heading)).setTypeface(font2);
			//			((TextView) rootView.findViewById(R.id.education_heading)).setTypeface(font2);
			//			((TextView) rootView.findViewById(R.id.current_job_show)).setTypeface(font);
			((TextView) rootView.findViewById(R.id.current_edu_show)).setTypeface(font);
		...
		new Handler().postAtTime(new Runnable() {
			...
			public void run() {
				...
				try{
					...
					Toast.makeText(context, "dddd "+e.getMessage(), 3000).show();
				}
			}
		}, 3000);
			...
			.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(GlobalClaass.isInternetPresent(context)){
						...
						removeJobFavorites = new RemoveJobFavorites(teacherObject.getId());
			...
			.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					if(GlobalClaass.isInternetPresent(context)){
						...
						addJobFavorites = new AddJobFavorites(teacherObject.getId());
