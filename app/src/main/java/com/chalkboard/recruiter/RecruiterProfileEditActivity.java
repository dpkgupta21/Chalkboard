...
import com.volley.CustomJsonImageRequest;
...
public class RecruiterProfileEditActivity extends Activity {
    ...
    private static final String TAG = "RecruiterProfileEditActivity";
    ...
    private File schoolMultiPartFile;
...
//                    recruiter_editprofile.execute();
        ...
        recuiter_aboutcompany.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (v.getId() == R.id.recuiter_aboutcompany) {
            ...
            case RESULT_CAMERA: {
                ...
                if (resultCode == context.RESULT_OK && null != data) {
                    ...
                    try {
                        ...
                        multiPartFile = new File(getCacheDir(), "profile.png");
            ...
            case RESULT_CAMERA1: {
                ...
                if (resultCode == context.RESULT_OK && null != data) {
                    ...
                    try {
                        ...
                        schoolMultiPartFile = new File(getCacheDir(), "school_photo.png");
                        schoolMultiPartFile.createNewFile();
                        ...
                        //write the bytes in file
                        FileOutputStream fos = new FileOutputStream(schoolMultiPartFile);
                        fos.write(bitmapdata);
                        fos.flush();
                        fos.close();
                    /*Bitmap photo = (Bitmap) data.getExtras().get("data");
...
//                        recuiter_photo.setImageBitmap(bitmap);
    ...
    private void editProfile() {
        if (Utils.isOnline(context)) {
            String name = recuiter_companyname.getText().toString();
            String country_id = recuiter_countryid.getText().toString();
            String address = recuiter_location.getText().toString();
            String description = recuiter_aboutcompany.getText().toString();


            CustomProgressDialog.showProgDialog(context, null);
            Map<String, String> params = new HashMap<>();
            params.put("action", "account_edit");
            params.put("user_id", GlobalClaass.getUserId(context));
            ...
            CustomJsonImageRequest postReq = new CustomJsonImageRequest(Request.Method.POST,
                    GlobalClaass.Webservice_Url, params, multiPartFile, schoolMultiPartFile,
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                if (Utils.getWebServiceStatus(response)) {
                                    ...
                                    Utils.customDialog(Utils.getWebServiceMessage(response), context);
                                }
                            } catch (
                                    Exception e
                                    )
...
//    class Recruiter_EditProfile extends AsyncTask<String, String, String> {
//
...
//                HttpPost request1 = new HttpPost(GlobalClaass.Webservice_Url);
//
//                try {
//
...
//                        entity1.addPart("image", new FileBody(multiPartFile));
//
//                    }
//                    if (schoolMultiPartFile != null) {
//
//                        entity1.addPart("school_photo", new FileBody(schoolMultiPartFile));
//                    }
//                    String name = recuiter_companyname.getText().toString();
//                    String country_id = recuiter_countryid.getText().toString();
//                    String address = recuiter_location.getText().toString();
//                    String description = recuiter_aboutcompany.getText().toString();
//
//                    entity1.addPart("action", new StringBody("account_edit"));
//                    entity1.addPart("user_id", new StringBody(GlobalClaass.getUserId(context)));
//                    entity1.addPart("name", new StringBody(name));
//                    entity1.addPart("country_id", new StringBody(country_id));
////					entity.addPart("city",new StringBody(recuiter_city.getText().toString()));
//                    entity1.addPart("address", new StringBody(address));
//                    entity1.addPart("description", new StringBody(description));
//
//
