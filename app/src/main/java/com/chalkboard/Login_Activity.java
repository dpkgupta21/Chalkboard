...
import com.chalkboard.recruiter.JobPreviewPage.GetJobDetail;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		handler = new Handler(){
			...
			public void handleMessage(Message msg) {
				Toast.makeText(context, ""+msg.getData().getString("USERNAME").toString(), 3000).show();
